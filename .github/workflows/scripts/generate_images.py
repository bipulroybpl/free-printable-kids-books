...
Each entry in prompts/image_prompts.json can independently include any of:
  - "prompt": "..."         -> writes assets/raw/page-N.png
  - "letter_prompt": "..."  -> writes assets/raw/page-N-letter.png
  - "object_prompt": "..."  -> writes assets/raw/page-N-object.png
Split letter/object pages are then composited via scripts/compose_split_panel.py.
A "letter" field with no "letter_prompt" (e.g. baby-first-abc, where the
letter side is code-generated by generate_abc_letters.py instead) simply
skips that half here -- only object_prompt is fetched.
"""
import argparse
import json
import os
